...
import (
	...
	"github.com/uswitch/kiam/pkg/k8s/client/clientset_generated/clientset/scheme"
...
// IamV1alpha1Client is used to interact with features provided by the iam.amazonaws.com group.
type IamV1alpha1Client struct {
	restClient rest.Interface
}

func (c *IamV1alpha1Client) IamRoles(namespace string) IamRoleInterface {
